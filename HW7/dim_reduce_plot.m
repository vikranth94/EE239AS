...
% u1: principle direction / factor loading
    ...
    % plot the original data projected down into the subspace defined by PC 1
    dataPC1 = repmat(mu,n,1) + repmat(u1',n,1).*repmat(z_hat,1,p); plot(dataPC1(:,1),dataPC1(:,2),'r.', 'markersize', 15)
    for i=1:n
